        ...
        public void handle(ActionEvent event) {
            ...
            if (empezar == false) {
                ...
                if (Math.random() < cuantos)  {
                    ...
                    if (numRandom == 1) {
                        Globo globo = new Globo(new Image("images/morado.png"), "morado");
                        globos.add(globo);
                    } else if (numRandom == 2){
                        Globo globo = new Globo(new Image("images/amarillo.png"), "amarillo");
                        globos.add(globo);
                    } else if (numRandom == 3){
                        Globo globo = new Globo(new Image("images/verde.png"), "verde");
                        globos.add(globo);
                    } else {
                        Globo globo = new Globo(new Image("images/rojo.png"), "rojo");
                        globos.add(globo);
                    }
                }
                ...
                for (int i = 0; i < globos.size(); i++) {
                    ...
                    //Al tocar con la nube el globo se dirige abajo en una posicion random, ya que el *clear no lo borra y hace que colisione todo el rato causando la perdida de todas las vidas en milesimas de segundo
                    if (globos.get(i).getColor().equals(colorAReventar)) {
                        if (globos.get(i).getBoundary().intersects(colision.getBoundary())) {
                            System.out.println("Globo colisiona con nubes");
                            vidas--;
                            globos.get(i).setPosY(800);
                            globos.get(i).setPosX(Math.random()*1300);
                        }
